...
### SearchScreen
- Экран поиска с текстовым полем
...
- Поддерживает ввод текста и будет отображать результаты поиска
- Отображает иерархию тегов из Firestore для тестирования и отладки
