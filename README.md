...
### 4. Индикатор разнообразия оборудования
...
### 5. Улучшения интерфейса поиска и выбора тегов
...
### 6. Добавление обучающего окна для новых пользователей
- **Новая функция:** Добавлено обучающее окно, которое появляется при первом запуске приложения после загрузки объектов на карту.
- **Интерфейс:** 
  - Реализовано в виде модального bottom sheet с drag handle (ручкой для перетаскивания)
  - Использован белый фон с черным текстом для лучшей читаемости
  - Добавлена кнопка закрытия и кнопка "Понятно!"
- **Содержание:** 
  - Краткие инструкции о том, как пользоваться приложением
  - Основные функции: просмотр деталей объектов, поиск и фильтрация
- **Техническая реализация:**
  - Использована библиотека `shared_preferences` для отслеживания первого запуска приложения
